...
import { Bars3Icon, BugAntIcon, MagnifyingGlassIcon, PencilSquareIcon, SparklesIcon, UserGroupIcon, UserIcon } from "@heroicons/react/24/outline";
      ...
      <div className="navbar-start w-auto lg:w-1/2">
        ...
        <Link href="/" passHref className="hidden lg:flex items-center gap-2 ml-4 mr-6">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs">Scaling up community moderation</span>
          </div>
        </Link>
